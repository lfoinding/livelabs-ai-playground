...
**Download the latest packaged skills** and view supporting docs from the [LiveLabs AI Developer Hub](https://github.com/lfoinding/livelabs-ai-playground) in the [LiveLabs-AI-Developer](https://github.com/lfoinding/livelabs-ai-playground/tree/main/LiveLabs-AI-Developer) folder.

In this workshop, you will move through a set of focused examples that show how to:

- turn a blog post or product page into a draft LiveLabs workshop
