...
1. Use `skills/how-to/workshop-author-skill/` for the guide on creating a workshop from a blog post or other source material.

2. Use `skills/how-to/screenshot-skill/` for the workshop-style guide on taking LiveLabs screenshots.

3. Use `skills/how-to/quiz-skill/` for the quiz-generation guide and packaged assets.

4. Use `skills/how-to/industry-converter-skill/` for the workshop-conversion guide and quick-reference README.
